    ...
    return (
      ...
      >
        <div
          ...
          style={{ backgroundColor: whiteBackground ? "white" : "#E2EEFC" }}
        >
          <svg
            width="16"
            height="16"
          ...
          >
            ...
            <g opacity="0.4">
              <path
                d="M11.7674 8.02442L10.1873 8.72131L8.97583 8.02442L10.1792 7.32349L11.7674 8.02442Z"
                fill="#1772D6"
              />
              <path
                d="M9.88352 11.2898L8.4938 10.2688L8.48975 8.86694L9.69714 9.55978L9.88352 11.2898Z"
                fill="#1772D6"
              />
              <path
                d="M7.5215 10.2607L6.11963 11.2898L6.306 9.57193L7.51745 8.86694L7.5215 10.2607Z"
                fill="#1772D6"
              />
              <path
                d="M7.03124 8.02833L5.82385 8.72521L4.2356 8.02428L5.81574 7.32739L7.03124 8.02833Z"
                fill="#1772D6"
              />
              <path
                d="M7.5134 7.18571L6.306 6.48882L6.11963 4.76282L7.5134 5.78384V7.18571Z"
                fill="#1772D6"
              />
              <path
                d="M9.88342 4.76282L9.69704 6.48072L8.4856 7.18166V5.78789L9.88342 4.76282Z"
                fill="#1772D6"
              />
            </g>
          </svg>
    ...
    return (
      ...
      >
        <div
          className="w-6 h-6 rounded-full flex items-center justify-center"
          style={{
            backgroundColor: whiteBackground ? "white" : "#F9D9D2",
            opacity: 0.7,
          }}
        >
          <svg
          ...
          >
            ...
            />
            <path
              d="M13.7593 7.34358C13.1547 5.84593 12.0246 4.61699 10.5743 3.88594L8.9186 3.05215L9.96972 4.58142C10.9458 5.99609 10.7482 7.53721 10.0092 8.14971C9.59432 8.49745 8.90675 8.616 8.31005 8.45003C7.60667 8.2564 7.00603 7.67947 6.91909 7.10649C6.86377 6.75085 7.01393 6.50585 7.27869 6.10674C7.51974 5.74714 7.7924 5.34013 7.85957 4.75924C8.00578 3.53425 7.16804 2.26184 5.29894 0.870875L4.10556 -0.0142822L4.56394 1.40039C4.89983 2.43571 4.93935 3.39199 4.67459 4.24158C4.41774 5.07142 3.97516 5.51795 3.4575 6.03956C2.93194 6.56907 2.33525 7.16971 1.97565 8.22084C1.27622 10.2559 2.07049 12.1448 2.23646 12.5004C2.67903 13.4488 3.39427 14.2786 4.30314 14.8911C5.16459 15.472 6.16039 15.8395 7.1799 15.9502C7.39724 15.9739 7.61853 15.9857 7.83982 15.9857C8.97787 15.9857 10.1317 15.6735 11.1433 15.0808C11.7677 14.7133 12.3209 14.251 12.7793 13.7096C13.2377 13.1722 13.6012 12.5597 13.8462 11.9037C14.3916 10.4535 14.3599 8.83333 13.7593 7.34358Z"
              fill="#E96549"
            />
          </svg>
        </div>
  ...
  if (mode === "auto") {
    return (
      ...
      >
        <div
          className="w-6 h-6 rounded-full flex items-center justify-center"
          style={{ backgroundColor: whiteBackground ? "white" : "#F3E9F6" }}
        >
          <svg
            width="24"
            height="24"
          ...
          >
            <circle
              ...
              cy="12"
              r="12"
              fill={whiteBackground ? "white" : "#F3E9F6"}
            />
            <path
              d="M15.1641 18L14.264 15.1555H9.73723L8.83719 18H6L10.3821 6H13.6014L18 18H15.1641ZM13.6357 13.0294L12.7356 10.2497C12.6785 10.0639 12.6036 9.82568 12.5109 9.53487C12.417 9.24285 12.3243 8.94593 12.2304 8.64413C12.1365 8.34111 12.0616 8.0784 12.0057 7.8548C11.9486 8.0784 11.8712 8.35455 11.7721 8.68445C11.6731 9.01436 11.5779 9.32593 11.4878 9.6204C11.3977 9.91488 11.3316 10.125 11.2923 10.2497L10.4011 13.0294H13.6369H13.6357Z"
              fill="#A85FBD"
            />
          </svg>
        </div>
